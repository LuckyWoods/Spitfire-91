...
%
\usepackage{url}
% url.sty was written by pdflatexDonald Arseneau. It provides better support for
...
\title{Spitfire '91, a WPF Shump}
%
%

% received ..."  text while in non-compsoc journals this is reversed. Sigh.

\author{Victor Gasior & Jaxx 'Lucky' Woods
}

\IEEEtitleabstractindextext{%
\begin{abstract}
Spitfire '91 is a retro inspired Shoot 'em Up game where you control a small airplane fighting drone, tank, and enemy aircraft. The target audiance for this project is fans of retro shoot 'em ups like EDF or UN Squadron. So far we have constructed just the basic plans for the project.
\end{abstract}
